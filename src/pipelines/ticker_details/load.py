...
TICKER_DETAILS_SCHEMA = Schema(
    ...
    NestedField(4, "sic_code", StringType(), required=False),
    NestedField(5, "sic_description", StringType(), required=False),
    NestedField(6, "description", StringType(), required=False),
    NestedField(7, "homepage_url", StringType(), required=False),
    NestedField(8, "market_cap", DoubleType(), required=False),
    NestedField(9, "total_employees", IntegerType(), required=False),
    NestedField(10, "list_date", StringType(), required=False),
    NestedField(11, "locale", StringType(), required=False),
    NestedField(12, "primary_exchange", StringType(), required=False),
    NestedField(13, "currency_name", StringType(), required=False),
    NestedField(14, "cik", StringType(), required=False),
    NestedField(15, "composite_figi", StringType(), required=False),
    NestedField(16, "share_class_figi", StringType(), required=False),
    NestedField(17, "address_city", StringType(), required=False),
    NestedField(18, "address_state", StringType(), required=False),
    NestedField(19, "address_country", StringType(), required=False),
    NestedField(20, "last_fetched_utc", StringType(), required=False),
...
TICKER_DETAILS_ARROW_SCHEMA = pa.schema(
    [
        ...
        pa.field("list_date", pa.string(), nullable=True),
